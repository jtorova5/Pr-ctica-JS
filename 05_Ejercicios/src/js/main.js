...
let cuadrado = raiz ** 2
let testCuadradoPerfecto = (cuadrado == num13)
...
let num14 = 5
let testFibonacci = (num14 == ((num14 - 1) + (num14 - 2)))

console.groupCollapsed('Ejercicio 16: ')
if (testFibonacci) {
    console.log(`${num14} = (${num14 - 1} + ${num14 - 2}), por lo tanto es un número de Fibonacci`)
} else {
...
let potencia = raiz2 ** 2
let testPotencia = (potencia == num15)
